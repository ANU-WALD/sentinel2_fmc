...
veg_map = ds.quality_mask.isel(time=0).where(veg_map_mask) # restrict veg mask to consistent veg type across years (with pixels values corresponding to veg id, PROBABLY quality_mask is actually a vegetation type mask) 
